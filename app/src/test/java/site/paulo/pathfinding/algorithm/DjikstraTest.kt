...
internal class DjikstraTest {
    ...
    fun `test Djikstra algorithm in grid graph`() {
        ...
        val djikstra = Djikstra(gridGraph, gridGraph.getNode(Pair(0,0))!!, gridGraph.getNode(Pair(2,2))!!)
        djikstra.run()
    ...
    fun `test Djikstra algorithm in grid graph - reverse`() {
        val gridGraph = GridGraph(3,3)
        val djikstra = Djikstra(gridGraph, gridGraph.getNode(Pair(2,2))!!, gridGraph.getNode(Pair(0,0))!!)
        djikstra.run()
    ...
    fun `test Djikstra algorithm in grid graph - no path - start at middle`() {
        ...
        val djikstra = Djikstra(gridGraph, gridGraph.getNode(Pair(0,0))!!, gridGraph.getNode(Pair(5,5))!!)
    ...
    fun `test Djikstra algorithm in grid graph - short grid graph`() {
        ...
        val djikstra = Djikstra(gridGraph, gridGraph.getNode(Pair(0,0))!!, gridGraph.getNode(Pair(1,1))!!)
    ...
    fun `test Djikstra algorithm in grid graph - shortest grid graph`() {
        ...
        val djikstra = Djikstra(gridGraph, gridGraph.getNode(Pair(0,0))!!, gridGraph.getNode(Pair(0,0))!!)
